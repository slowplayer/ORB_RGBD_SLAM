...
inline void IcpSolver::add(const Eigen::Vector3f& point, const Eigen::Vector3f& corresponding_point, float weight)
{
  if(weight==0.0f)
    return;
...
inline Eigen::Affine3f IcpSolver::getTransformation()
{
